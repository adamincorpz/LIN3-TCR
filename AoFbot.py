...
􀜁􀇔􏿿 Bye all        
 ...
 􀜁􀇔􏿿 http://line.me/ti/p/~aofbot 􀜁􀇔􏿿
...
wait = {
    ...
    'autoAdd':True,
    'message':"""THX FOR ADD : 
🐺promotion, for a minute 

🤖Admin Bot Protect :
🕛อ๊อฟคุง บริการ 24 ชม.🕛
⚪รับติดตั้งแก้ไขบอทไลน์⚪
⚫รับเขียนบอทตอบโต้ระบบ API⚫
⚪รับทำไลน์ส่วนตัวตามต้องการ⚪

🏄Admin Bot Protect :
⚫รับรันบัญชีและลบห้องรัน⚫
⚪รับดึงลูกค้า/ลูกแชร์ VIP ⚪
⚫รับทำปกห้อง/โลโก้สวยๆ⚫
⚪รับงานเลขาด้วยนะคับ⚪

🏖Admin Bot Protect:
⚫จำหน่ายสติ๊กเกอร์/ธีมไลน์⚫
⚪บริการด้านอื่นๆสตเพิ่มเติมนะครับ⚪
บริการทุกระดับประทับใจ โปรดเรียกใช้อ๊อฟคุงนะคร๊าฟฟ
